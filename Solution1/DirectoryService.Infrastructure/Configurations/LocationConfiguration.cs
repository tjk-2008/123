...
public class LocationConfiguration : IEntityTypeConfiguration<Location>
{
    public void Configure(EntityTypeBuilder<Location> builder)
    {
        ...
        builder.Property(l => l.Address)
            .HasConversion(
                addr => addr.Value,
                value => LocationAddress.Create(value)
            )
        ...
        builder.Property(l => l.LifeTime)
            .HasColumnName("life_time")
            .HasConversion(
                lt => $"{lt.CreatedAt}|{lt.UpdatedAt}|{lt.IsActive}",
                value => ParseLifeTime(value))
            .IsRequired();
    }
